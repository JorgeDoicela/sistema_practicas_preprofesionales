        ...
        <aside className="w-72 bg-[#003366] text-white flex flex-col h-screen sticky top-0 border-r border-white/5 shadow-2xl z-40">
            ...
            <div className="p-6">
                <div className="bg-white/5 rounded-3xl p-5 border border-white/10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest mb-1">Prácticas Preprofesionales</p>
                    <p className="text-[11px] text-white/50 mb-4 font-medium leading-tight">Gestión del perfil profesional.</p>
