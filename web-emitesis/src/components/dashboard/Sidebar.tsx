            ...
            <div data-tour="sidebar-footer" className="p-6">
                ...
                <div className="mb-4 px-5">
                    <div className="flex items-center gap-2.5 py-2">
                        ...
                        <span className="text-[9px] font-black text-emerald-400/80 uppercase tracking-[0.2em]">{t.sidebar.secureSession ?? 'Sesión Segura'} · {t.login.security?.encrypted || 'Protegida'}</span>
                    </div>
                </div>
